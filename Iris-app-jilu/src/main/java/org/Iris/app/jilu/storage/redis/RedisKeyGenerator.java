...
public class RedisKeyGenerator {
	...
	private static final String GLOBAL_MERCHANT_ID					= "string:global-merchant-id";				// 商户 ID 记录
	...
	public static String getGlobalMerchantIdKey(){
		return GLOBAL_MERCHANT_ID;
	}
	
	public static String getMemMerchantDataKey(long uid) { 
		return MessageFormat.format(MEM_MERCHANT_DATA, String.valueOf(uid));
	}
}
