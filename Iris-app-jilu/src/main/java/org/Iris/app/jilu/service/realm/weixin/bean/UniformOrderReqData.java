package org.Iris.app.jilu.service.realm.weixin.bean;
...
public class UniformOrderReqData {
     ...
     */
    public UniformOrderReqData(String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String notify_url,String trade_type){
