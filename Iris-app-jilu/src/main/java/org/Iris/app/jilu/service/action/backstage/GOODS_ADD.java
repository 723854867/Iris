...
public class GOODS_ADD extends BackstageAction {
	...
	protected String execute0(IrisSession session) {
		...
		return backstageService.insertGoods(BeanCreator.newMemGoods(goodsCode, zhName, usName, goodsFormat, classification, zhBrand, 
				usBrand, unit, weight, alias, barcode, sku,unitPrice));
	}
}
