...
var serverbase='';
$.ajax({
    url:serverbase+'/qydj/backstage?action=menulist_get',
    dataType: 'json',
    method: 'GET',
    success: function(data) {
    	...
    	var htmlMenu="";
    	htmlMenu=htmlMenu+"<li><a href='../home/index.html'> <i class='glyphicon glyphicon-home'></i> 首页</a></li>";
...
function SelectParentPage()
{
	...
	var curpagepath=curpagepathname.replace("/qydj/admin/", "");
	$.ajax({
	    url:serverbase+'/qydj/backstage?action=sys_page_getparent&pagePath='+curpagepath,
	    dataType: 'json',
	    method: 'GET',
	    success: function(data) {
	    	//debug;
