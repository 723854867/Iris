...
public class GlobalTrafficShapingHandler extends AbstractTrafficShapingHandler {
     ...
     *
     * @param executor      the {@link java.util.concurrent.ScheduledExecutorService} to use for the {@link com.spnetty.netty.traffic.TrafficCounter}
     ...
     */
    public GlobalTrafficShapingHandler(ScheduledExecutorService executor, int writeLimit,
                                       int readLimit, long checkInterval) {
