...
<head> 
    ...
    <title>${video.user.name}的【LIVE】“${video.description}”</title>
    ...
    <div class="main-inner">
        ...
        var videohost = 'http://cdn.wopaitv.com';
            ...
            function playVideo(id, title, desc, username, avatar, date,videoPic){
                ...
                if(id){
                    document.title = username + '的【LIVE】“'+ title +'”';
                    $('.user, .body').show();
                    $('.body').empty();
...
<div class="foot">
    <div class="foot-inner">
        ...
        <a href="http://www.wopaitv.com" target="_blank" class="download">下载LIVE</a>
    </div>
</div>
</body>
</html>
