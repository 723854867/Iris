...
define(['../libs/jquery-2.1.4','../libs/jquery.qqFace','../common/share','../common/playbox2','../libs/md5Utils','../common/aler'],function(jquery,face,share,playbox,md5Utils,alert){
	var a = 0;
					...
					success : function(data) {
						if (data["code"] == "200") { // code==200,表示请求成功
							...
							setInterval(function(){
								...
								if(infos.getCookie('back') == 'unbind'){
									window.location.href=infos.getRequestPrefix()+'/pay/login?back=unbind';
								}else{
									window.location.href=infos.getRequestPrefix()+'/pay/login';
								}
