...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/personalCenter/myFans.css?t=<%=new java.util.Date().getTime()%>">
</head>
<body>
...
<script type="text/javascript" data-main="<%=request.getContextPath()%>/js/views/myFans" src="<%=request.getContextPath()%>/js/libs/require.js"></script>