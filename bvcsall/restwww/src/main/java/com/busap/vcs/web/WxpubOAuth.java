...
public class WxpubOAuth {
    ...
    public static void main(String[] args) {
        try {
            String url = createOauthUrlForCode("wx8a908b16f1e26ade", "http://ceshi.wopaitv.com/restwww/pay/wechatCallback", false);
    ...
    private static String httpBuildQuery(Map<String, String> queryString) throws UnsupportedEncodingException {
        ...
        return sb.toString() + "#wechat_redirect";
    }
