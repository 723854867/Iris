...
public class Client {
	...
	private String sn = "SDK-BBX-010-23818";// 序列号
	private String password = "672806-A";
	...
	public String mdsmssend(String mobiles,String content){
		if (mobiles.startsWith("00")) {//有国际区号，用国际短信
			return mdsmssend_g(mobiles, content);
		} else {
			String newServiceUrl = "http://sdk2.entinfo.cn:8061/mdsmssend.ashx?sn="
					+ sn + "&pwd="+ pwd 
					+"&mobile="+ mobiles +"&content="+ content +"&ext=&stime=&rrid=&msgfmt=";
			String result = HttpUtil.doGet(newServiceUrl, 10);
			logger.info("短信发送完成，号码：{}，内容：{}，结果：{}",mobiles,content,result);
			return result;
		}
	}
	/**
	 ...
	 * @return
	 */
	public String mdsmssend_g(String mobiles,String content){
		String newServiceUrl = "http://sdk2.entinfo.cn:8060/gjWebService.asmx/mdSmsSend_g?sn="
				+ sn + "&pwd="+ pwd 
				+"&mobile="+ mobiles +"&content="+ content +"&ext=&stime=&rrid=";
		String result = HttpUtil.doGet(newServiceUrl, 10);
		logger.info("短信发送完成，号码：{}，内容：{}，结果：{}",mobiles,content,result);
		return result;
	}
	public static void main(String[] args) {
		Client c = new Client();
		System.out.println(c.mdsmssend("18910980001", "LIVE,hello【巴士在线】"));
	}
//	/*
//	 * 构造函数
//	 */
