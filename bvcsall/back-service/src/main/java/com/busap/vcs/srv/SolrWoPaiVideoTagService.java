...
public class SolrWoPaiVideoTagService {
	...
	public int deleteDocByQuery(String videoId) throws SolrServerException, IOException{
		UpdateResponse updateResponse = server.deleteByQuery("videoid:"+videoId);
		server.commit();
		int status = updateResponse.getStatus();
		return status;
	}
	...
	public List<Long> search(String name,long id) throws SolrServerException{
