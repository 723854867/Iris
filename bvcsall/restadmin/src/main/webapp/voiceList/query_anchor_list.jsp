    ...
    <script type="text/javascript">
        ...
        function getVoiceListDetailInfo() {
            $('#displayVoiceListTable').datagrid({
                ...
                columns: [
                    [
                        {field: 'destId', title: '<span class="columnTitle">用户ID</span>', width: 40, align: 'center'},
                        ...
                        {field: 'createTime', title: '<span class="columnTitle">加入时间</span>', width: 80, align: 'center'},
                        {
                            ...
                            formatter: function (value, row) {
                                var popularity = '<a class="easyui-linkbutton" href="javascript:;" onclick="cheatVoteDialog(' + row.destId + ')" style="width:80px;height: 25px;" title="加人气"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">加人气</span><span class="l-btn-icon icon-add">&nbsp;</span></span></a>';
                                return popularity;
                            }
                        }
                    ]
