...
<div id="dataGridToolbar" region="north" border="false"
    ...
    <div data-options="region:'north',border:false"
        ...
        <h2 style="float:left;padding-left:10px;margin: 1px">
            <a href="voiceList/forwardVarietyList" <c:if test="${selected eq 'variety'}">class="bc" </c:if> style="text-decoration: none;color: #000;">${voiceListName}</a>
            <%--<a href="voiceList/forwardContributionList" <c:if test="${selected eq 'contribution'}">class="bc" </c:if> style="text-decoration: none;color: #000;">贡献榜</a>--%>
        </h2>
    </div>
</div>
