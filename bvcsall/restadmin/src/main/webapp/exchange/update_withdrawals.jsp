            ...
            <tr>
                ...
                <td style="text-align: left;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <input type="text" name="price" id="price" disabled="disabled" style="width: 200px;"
                                   class="easyui-numberbox" min="0.01" precision="2" required="true"
                                   missingMessage="必须填写大于0的数字"
