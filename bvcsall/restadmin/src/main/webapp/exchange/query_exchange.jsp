...
<head>
    <title>兑换管理</title>
    <script type='text/javascript' src='js/admin/query_exchange.js'></script>
    <style>
        .bc{
    ...
    <div id="search_form">
        <table>
            <tr>
                ...
                <td>
                    <a href="javascript:;" onclick="doSearch(1)" class="easyui-linkbutton"
        ...
        <table class="table-doc" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    ...
                    <input type="text" name="pointCount" onKeyUp="calculationGoldCoin()" id="pointCount" class="easyui-validatebox" required="true" missingMessage="必须填写大于0的数字" style="width: 200px;" value="">
                </td>
            </tr>
            <tr>
                <td style="text-align: right;">金币数量：</td>
                <td style="text-align: left;">
                    <input type="hidden" name="diamondCount" id="diamondCount" value="">
                    <span id="diamondCountDisplay">
