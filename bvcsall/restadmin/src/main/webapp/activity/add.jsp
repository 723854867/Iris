...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center',border:false" style="padding:5px;margin:0 auto;">
		<form id="myform" method="post" action="activity/createupdate">
				<table cellpadding="5" style="margin:0 auto;width:900px;text-align: center;" class="form-body" >
				<tr>
					<td>输入标题:</td>
					<td><input class="easyui-validatebox f1 easyui-textbox" name="title" id="title" style="width:50%" data-options="validType:'length[0,20]',novalidate:true"></input></td>
				</tr>
				<tr>
					<td>封面:</td>
					<td>
					<input name="hlsfiles" id="hlsfiles" type="file" style="width:50%"></input>
					<input name="cover" id="cover"  type="hidden" style="width:50%"></input>
				...
				<tr>
					<td>排序权重:</td>
					<td>
					<input name="order_num" id="order_num"  class="easyui-validatebox f1 easyui-textbox"  style="width:50%"></input>
					<div style="margin-left:auto;margin-right:auto;width:400px;display:none" id="p" class="easyui-progressbar" ></div>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center">
					<a href="javascript:void(0)" style="" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="$('#myform').submit();">添加</a>
					</td>
				</tr>
			</table>
		</form>
