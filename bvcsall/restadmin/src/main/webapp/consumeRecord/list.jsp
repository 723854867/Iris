...
<head>
    ...
    <script type='text/javascript' src='js/admin/query_consume_record.js'></script>
...
// 		}
	...
	function exportData(){
	    ...
	    window.location.href = "consumeRecord/findConsumeRecordByUserExport?startDate="+startDate+"&endDate="+endDate+"&paramType="+paramType+"&param="+param+"&oId="+oId+"&gId="+gId;
	}
...
<div id="tb" region="north" border="false"
    ...
    <div data-options="region:'north',border:false"
        ...
        <h2 style="float:left;padding-left:10px;margin: 1px">收取礼物查询</h2>
    </div>
    <div>
            	...
            	<tr id="common_tr">
                    ...
                    <td>
                        <input type="text" class="easyui-datetimebox" name="startDate"
                               id="startDate" style="width: 150px;"> 至 <input
                            type="text" class="easyui-datetimebox" name="endDate"
                            id="endDate" style="width: 150px;">
                    </td>
                	...
                	<tr>
                	<td>
                    	&nbsp;&nbsp;折合金豆总数：<c:out value="${pSum }"></c:out><span id="pSum" ></span>
                	</td>
                	<td>
                    	&nbsp;&nbsp;折合现金总数（元）:<c:out value="${imSum }"></c:out><span id="imSum" ></span>
                	</td>
                </tr>
            </table>
        </form>
