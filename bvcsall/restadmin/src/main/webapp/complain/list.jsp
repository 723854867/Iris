...
<head>
    ...
    <script type='text/javascript' src='js/admin/query_complain.js'></script>
</head>
<body>
<!-- 列表 -->
...
<div id="tb" region="north" border="false"
    ...
    <div data-options="region:'north',border:false"
        ...
        <h2 style="float:left;padding-left:10px;margin: 1px">用户投诉</h2>
    </div>
    <div>
        <form action="" id="searchForm">
            <table>
                <tr>
                    ...
                    <td>
                        <select name="filters['title']" class="easyui-combobox">
                    ...
                    <td>
                        <select name="filters['stat']" class="easyui-combobox">
                            <option value="All" selected>全部</option>
