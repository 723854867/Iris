...
<html  style="background: white">
 <head>
    ...
    <meta http-equiv="content-type" content="text/html; charset=UTF-8"/>
     ...
     var listUrl="subject/listpage";
     var updateUrl="subject/updatepage";
     var deleteUrl="subject/delete";
     var addUrl="subject/create";
...
<body>
	...
	<div id="updatedlg" class="easyui-dialog" style="width:400px;height:380px;padding:10px 20px" closed="true" buttons="#updatedlg-buttons">
		...
		<form id="updatefm" method="post" novalidate>
			...
			<div class="fitem">
				<label>专题状态:</label>
				<select class="easyui-select" name="useStat">
					<option value="active">活动</option>
					<option value="unactive">非活动</option>
				</select>
			</div>
			<input type="hidden" name="id"/>
		</form>
