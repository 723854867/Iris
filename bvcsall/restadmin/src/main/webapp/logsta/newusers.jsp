...
<html>
	<head>
		...
		<script type='text/javascript' src="./js/admin/query_logsta.js"></script>
	</head>
	<body>
		...
		<div id="dataGridToolbar" region="north" border="false"
			...
			<div data-options="region:'north',border:false"
				...
				<h2 style="float: left; padding-left: 10px; margin: 1px">新增用户表</h2>
			</div>
			<div>
				<table>
					<tr>
						...
						<td>
							...
							&nbsp;至&nbsp;
							<input type="text" class="easyui-datebox" style="width: 120px;" name="endTime" id="endTime"></td>
						<td>
						<a href="javascript:;" onclick="doSearch()" class="easyui-linkbutton" iconCls="icon-search">搜索</a></td>
					</tr>
				</table>
			</div>
		</div>
