        ...
        <table class="table-doc" cellspacing="0" width="100%">
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="hidden" name="id" style="width: 200px;" value="${singerType.id}">
                    <input type="text" name="name" required="true" style="width: 200px;" class="easyui-validatebox" value="${singerType.name}">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <select class="easyui-combobox" name="state">
                        <option value="1" <c:if test="${singerType.state eq 1}">selected="selected"</c:if>>正常</option>
                        <option value="0" <c:if test="${singerType.state eq 0}">selected="selected"</c:if>>删除</option>
                    </select>
                </td>
            </tr>
        </table>
