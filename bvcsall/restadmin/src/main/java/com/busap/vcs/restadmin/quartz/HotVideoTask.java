...
public class HotVideoTask implements Job {

	private static final Logger logger = LoggerFactory.getLogger(HotVideoTask.class);
	
	private VideoService videoService;


	public void execute(JobExecutionContext context) throws JobExecutionException {
//		logger.info("find hot videos once");
//		ApplicationContext appCtx = SpringWebUtils.getApplicationContext();
//		videoService = (VideoService) appCtx.getBean("videoService");
//		videoService.putHotIndiceVideosToRedis(500);
	}
}
