...
public class SingOtherTask implements Job {

	private static final Logger logger = LoggerFactory.getLogger(SingOtherTask.class);
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		singVoteService.createRank(2);
		singVoteService.createRank(3);
		singVoteService.createRank(4);
		singVoteService.createRank(5);
	}
