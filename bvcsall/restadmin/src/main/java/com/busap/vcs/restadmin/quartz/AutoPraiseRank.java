...
public class AutoPraiseRank {

	/*
	 * @Autowired private SchedulerFactoryBean schedulerFactoryBean;
	 */
	private QuartzProducer quartzProducer;
	private static String JOB_GROUP_NAME = "auto_praise_group";
	private static String JOB_NAME = "auto_praise_job";
	...
	public void initDelayJob() {
		try {
			...
			JobDetail jobDetail = new JobDetail(JOB_NAME, JOB_GROUP_NAME, AutoPraiseTask.class);// 任务名，任务组，任务执行类
