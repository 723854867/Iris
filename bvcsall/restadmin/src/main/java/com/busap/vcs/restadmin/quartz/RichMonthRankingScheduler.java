...
public class RichMonthRankingScheduler {

	/*
	 * @Autowired private SchedulerFactoryBean schedulerFactoryBean;
	 */
	private QuartzProducer quartzProducer;
	private static String JOB_GROUP_NAME = "rich_month_ranking_group";
	private static String JOB_NAME = "rich_month_ranking_job";
	...
	public void initDelayJob() {
		try {
			...
			JobDetail jobDetail = new JobDetail(JOB_NAME, JOB_GROUP_NAME, RichMonthRankingTask.class);// 任务名，任务组，任务执行类
