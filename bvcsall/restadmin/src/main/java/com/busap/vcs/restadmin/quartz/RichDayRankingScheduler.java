...
public class RichDayRankingScheduler {

	/*
	 * @Autowired private SchedulerFactoryBean schedulerFactoryBean;
	 */
	private QuartzProducer quartzProducer;
	private static String JOB_GROUP_NAME = "rich_day_ranking_group";
	private static String JOB_NAME = "rich_day_ranking_job";
	...
	public void initDelayJob() {
		try {
			...
			JobDetail jobDetail = new JobDetail(JOB_NAME, JOB_GROUP_NAME, RichDayRankingTask.class);// 任务名，任务组，任务执行类
