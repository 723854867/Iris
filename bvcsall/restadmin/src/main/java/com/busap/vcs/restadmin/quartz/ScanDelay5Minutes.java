...
public class ScanDelay5Minutes {

	/*
	 * @Autowired private SchedulerFactoryBean schedulerFactoryBean;
	 */
	private QuartzProducer quartzProducer;
	private static String JOB_GROUP_NAME = "delay5m_group";
	private static String JOB_NAME = "delay5m_job";
	...
	public void initDelayJob() {
		try {
			...
			JobDetail jobDetail = new JobDetail(JOB_NAME, JOB_GROUP_NAME, OverdueRecallTimerTask.class);// 任务名，任务组，任务执行类
