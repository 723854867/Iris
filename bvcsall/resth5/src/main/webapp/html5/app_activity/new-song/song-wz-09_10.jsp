...
<div class="box">
	<img src="<%=request.getContextPath()%>/html5/app_activity/new-song/img/0910.jpg" class="box-bg" alt=""/>
	<div class="footer">
		<p>
...
<script>
	...
	$(function(){
		...
		var sharePic = 'http://api.wopaitv.com/resth5/html5/app_activity/new-song/img/910share.jpg';
