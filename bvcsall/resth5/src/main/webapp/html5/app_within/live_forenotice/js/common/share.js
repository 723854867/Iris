...
//                	}
        ...
        shareOther: function(type,tit,desc,pic,noticeId,uid,isLive){
        	if(isLive==1){
        		var url= window.location.host+'/resth5/live/shareLiveNotice' //获取当前页面url不带参数'http://www.baidu.com/';//
        		var params1= {
                        title: tit+"的LIVE直播预告",
            ...
            if(type == 'qq'){
                ...
                window.open("http://v.t.sina.com.cn/share/share.php?url="+encodeURI("http://"+urlwb)+"&title="+tit+"的LIVE直播预告&pic="+pic+"&content="+desc);
            }
        }
    };
