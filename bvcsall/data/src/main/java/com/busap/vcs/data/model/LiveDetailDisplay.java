 ...
 */
public class LiveDetailDisplay {
	...
	private Integer uv;		//观看人数
	
	private Integer userChatCount;
	
	private Integer anchorChatCount;
	...
	public Integer getUserChatCount() {
		return userChatCount;
	}

	public void setUserChatCount(Integer userChatCount) {
		this.userChatCount = userChatCount;
	}
