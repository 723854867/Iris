...
public class SolrVideoService {
	...
	public void init(){
		...
		solr.setDefaultCollection("video");
	...
	public void addVideo(long id,String name) throws SolrServerException, IOException{  
		//创建doc文档
	    SolrInputDocument doc = new SolrInputDocument();
	    doc.addField("id", id);
	    doc.addField("description", name);
		server.add(doc);
		server.commit();
...
//		    SolrDocumentList results = queryResponse.getResults(); 
	...
	public static void main(String []str){
		...
		try {
			...
			//s.search("\\?");
			SolrVideoService server = new SolrVideoService();
			server.addVideo(1000,"梵蒂冈我拍阿萨德" );
		} catch (Exception e) {
